...
//#include <acado/reference_trajectory/global.hpp>
 ...
 *
 *	 \author Hans Joachim Ferreau, Boris Houska, Simon Spronk
 */
class AdaptiveReferenceTrajectory : public ReferenceTrajectory//, public virtual Estimator
{
	
	//mutable int CurrentObjective;
	//
	...
	public:
		 ...
		 */
		AdaptiveReferenceTrajectory( 	const VariablesGrid& _yRef
										);
		 ...
		 */
		AdaptiveReferenceTrajectory(	const char* const _yRefFileName
										);
	...
	protected:
		...
		/*virtual returnValue getStateEstimates (	DVector& xEst
												) const;*/
